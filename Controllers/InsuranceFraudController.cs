...
{
    public class InsuranceFraudeController : BaseController
    {
        #region Constructors

        public InsuranceFraudeController()
        {
            IgnorePause = false;
            IgnoreModal = false;
        ...
        public static void ProcessState()
        {
            try
            {
                // Insurance Fraud Behavior
                InsuranceFraudBehavior.ProcessState();
            }
            catch (Exception ex)
            {
                Log("Exception [" + ex + "]");
        ...
        public override void DoWork()
        {
            try
            {
                ...
                {
                    Log("AbyssalDeadspaceController: if (ESCache.Instance.InStation && ESCache.Instance.PauseAfterNextDock)");
                ...
                {
                    Log("AbyssalDeadspaceController: if (ESCache.Instance.InStation && ESCache.Instance.DeactivateScheduleAndCloseAfterNextDock)");
