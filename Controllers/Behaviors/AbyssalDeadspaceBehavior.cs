...
{
    public class AbyssalDeadspaceBehavior
    {
        #region Constructors

        public AbyssalDeadspaceBehavior()
        {
        ...
        // need to extend abyssalboundaries in this case, because some npcs sit on the edge -- and drones flying towards it passing through the 75k diameter
        public bool AreDronesWithinAbyssBounds => Drones.AllDronesInSpace.All(d => IsSpotWithinAbyssalBounds(d._directEntity.DirectAbsolutePosition, 25000));
        ...
        public static bool AbyssalDeadspaceAvoidBioluminescenceClouds
        {
            get
            {
                ...
                if (!ESCache.Instance.ActiveShip.IsShieldTanked && ESCache.Instance.Modules.All(i => !i.IsShieldRepairModule))
                    return false;
        ...
        public static void LoadSettings(XElement CharacterSettingsXml, XElement CommonSettingsXml)
        {
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: NumOfYellowBoxingAbyssalBCsToPullDrones [" + NumOfYellowBoxingAbyssalBCsToPullDrones + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: NumOfYellowBoxingAbyssalScyllaTyrannosToPullDrones [" + NumOfYellowBoxingAbyssalScyllaTyrannosToPullDrones + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: NumOfYellowBoxingAbyssalEphialtesCruisersToPullDrones [" + NumOfYellowBoxingAbyssalEphialtesCruisersToPullDrones + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: NumOfYellowBoxingAbyssalNPCsToPullDrones [" + NumOfYellowBoxingAbyssalNPCsToPullDrones + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: AbyssalDeadspaceBookmarkName [" + AbyssalDeadspaceBookmarkName + "]");
            HomeBookmarkName =
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: AbyssalDeadspaceFilamentName [" + AbyssalDeadspaceFilamentName + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: AbyssalDeadspaceFilamentsToStock [" + AbyssalDeadspaceFilamentsToStock + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: GlobalAbyssalDeadspaceAvoidDeviantAutomataSuppressorTowers [" + GlobalAbyssalDeadspaceAvoidDeviantAutomataSuppressorTowers + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: GlobalAbyssalDeadspaceAvoidMultibodyTrackingPylonTowers [" + GlobalAbyssalDeadspaceAvoidMultibodyTrackingPylonTowers + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: AbyssalDeadspaceCloudRange [" + AbyssalDeadspaceCloudRange + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: AbyssalDeadspaceTowerRange [" + AbyssalDeadspaceTowerRange + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: GlobalAbyssalDeadspaceAvoidBioluminescenceClouds [" + GlobalAbyssalDeadspaceAvoidBioluminescenceClouds + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: GlobalAbyssalDeadspaceAvoidTachyonClouds [" + GlobalAbyssalDeadspaceAvoidTachyonClouds + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: GlobalAbyssalDeadspaceAvoidFilamentClouds [" + GlobalAbyssalDeadspaceAvoidFilamentClouds + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: HealthCheckMinimumShieldPercentage [" + HealthCheckMinimumShieldPercentage + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: HealthCheckMinimumArmorPercentage [" + HealthCheckMinimumArmorPercentage + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: HealthCheckMinimumCapacitorPercentage [" + HealthCheckMinimumCapacitorPercentage + "]");
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: AbyssalPocketWarningSeconds [" + AbyssalPocketWarningSeconds + "]");

            ESCache.Instance.TriglavianConstructionSiteSpawnFoundDozenPlusBsSpawnRunAway =
            ...
            Log.WriteLine("AbyssalDeadspaceBehavior: abyssalConstructionSite14BSSpawnRunAway [" + ESCache.Instance.TriglavianConstructionSiteSpawnFoundDozenPlusBsSpawnRunAway + "]");
        }
        ...
        private static bool ShouldWeGoIdle()
        {
            try
            {
                var spanTotalSeconds = Math.Round((DateTime.UtcNow - Time.Instance.Started_DateTime).TotalSeconds, 0);
                Log.WriteLine($"_abyssalControllerStarted [{Time.Instance.Started_DateTime}] spanTotalSeconds [{spanTotalSeconds}]");
                ...
                if (rnd >= 0.10d)
                {
                    ...
                    if (rnd >= 0.40d)
                    {
                        _idleUntil = DateTime.UtcNow.AddSeconds(new Random().Next(idleDurationMin, idleDurationMax));
                    }
                    else
                    {
                        _idleUntil = DateTime.UtcNow.AddSeconds(new Random().Next(idleDurationMin / 2, idleDurationMax / 2));
                    }
                    return true;
                }
                else
                {
                    _idleUntil = DateTime.UtcNow.AddSeconds(new Random().Next(idleDurationMin * 4, idleDurationMax * 4));
                    return true;
                }
                //return false;
            }
        ...
        private static bool _sessionChangeIdleCheck = false;
        private static DateTime _idleUntil = DateTime.MinValue;
        ...
        private static bool HandleAbyssalActivationWindow()
        {
            try
            {
                if (abyssActivationWindow != null && abyssActivationWindow.PyWindow.IsValid)
                {
                    ...
                    {
                        Log.WriteLine("We have activated the AbyssalActivationWindow: Waiting to be moved to AbyssalDeadspace");
                        return false;
                    }

                    Log.WriteLine("ActivateAbyssalDeadspaceState: Found abyssActivationWindow");
                ...
                if (keyActivationWindow != null && keyActivationWindow.PyWindow.IsValid)
                {
                    ...
                    if (ESCache.Instance.DirectEve.Me.IsInvuln) //&& !IsAnyOtherNonFleetPlayerOnGrid)
                    {
                        if (DirectEve.Interval(2500, 3500))
                        {
                            ...
                            Log.WriteLine($"Moving into a random direction to break the abyss invuln timer.");
                            return false;
                        }
                    }
        ...
        private static bool HandleFilaments()
        {
            try
            {
                DirectItem fila = ESCache.Instance.CurrentShipsCargo.Items.Find(i => i.GroupId == (int)Group.AbyssalDeadspaceFilament && i.TypeName.Contains(AbyssalDeadspaceFilamentName));
                if (fila != null)
                {
        ...
        private static bool HandleAbyssalTrace()
        {
            try
            {
                if (ESCache.Instance.EntitiesOnGrid.Any(i => i.GroupId == (int)Group.AbyssalTrace) && ESCache.Instance.ClosestStation != null && !ESCache.Instance.ClosestStation.IsOnGridWithMe)
                {
                    ...
                    {
                        Log.WriteLine("AbyssalTrace.Distance [" + AbyssalTrace.Nearest1KDistance + "k] > [" + Math.Round((double)Distances.GateActivationRange / 1000, 0) + "k]");
                    ...
                    {
                        Log.WriteLine("ActiveShip.Entity.Velocity < 100: Slow is dangerous: keep your transversal up");
                        AbyssalTrace.Orbit(500);
                        return false;
                    }
        ...
        private static void ArmCMBState(int FilamentsToLoad = 1)
        {
            ...
            //if (AbyssalController.NeedToDumpDatabaseSurveys())
            //{
            //    Log.WriteLine("Begin DumpSurveyDatabases");
            //    ChangeAbyssalDeadspaceBehaviorState(AbyssalDeadspaceBehaviorState.DumpSurveyDatabases, false, null);
            //    return;
            //}
            ...
            get
            {
                if (ESCache.Instance.InAbyssalDeadspace)
                {
                    if (_assumeGatesAreLockedOrThereAreNoGates == null)
                    {
                        ...
                        {
                            if (ESCache.Instance.TriglavianConstructionSiteSpawnFoundDozenPlusBsSpawnRunAway && ESCache.Instance.AccelerationGates.Count > 0) //&& 55000 > ESCache.Instance.AccelerationGates.FirstOrDefault().Distance)
                            {
        ...
        public static void ExecuteAbyssalDeadspaceSiteState()
        {
            if (!ESCache.Instance.InSpace)
            {
                if (ESCache.Instance.InStation)
                {
                    ...
                    {
                        Log.WriteLine("AbyssalDeadspaceBehavior: ExecuteAbyssalDeadspaceSiteState: You are in a capsule: you died.");
                        ESCache.Instance.PauseAfterNextDock = true;
                        return;
                    }
                }
            ...
            //if (ESCache.Instance.CurrentShipsCargo == null && ESCache.Instance.Wrecks.Any())
            //{
            ...
            if (keyActivationWindow != null && !ESCache.Instance.Paused)
            {
                keyActivationWindow.Close();
            }

            if (abyssActivationWindow != null && !ESCache.Instance.Paused)
            {
        ...
        private static void IdleCMBState()
        {
            ...
            {
                Log.WriteLine($"Idle in station until [{_idleUntil}].");
            }
    ...
    public class AbyssalSiteStatistics
    {
        private DateTime AbyssalPocket1StartTime = DateTime.MinValue;
        private DateTime AbyssalPocket2StartTime = DateTime.MinValue;
        private DateTime AbyssalPocket3StartTime = DateTime.MinValue;
        private DateTime AbyssalSiteFinished = DateTime.MinValue;

        private TimeSpan AbyssalPocket1Time
        {
            get
            {
                if (AbyssalPocket1StartTime == DateTime.MinValue || AbyssalPocket2StartTime == DateTime.MinValue)
                    return TimeSpan.Zero;

                return AbyssalPocket1StartTime - AbyssalPocket2StartTime;
            }
        }

        private TimeSpan AbyssalPocket2Time
        {
            get
            {
                if (AbyssalPocket2StartTime == DateTime.MinValue || AbyssalPocket3StartTime == DateTime.MinValue)
                    return TimeSpan.Zero;

                return AbyssalPocket2StartTime - AbyssalPocket3StartTime;
            }
        }

        private TimeSpan AbyssalPocket3Time
        {
            get
            {
                if (AbyssalPocket2StartTime == DateTime.MinValue || AbyssalPocket3StartTime == DateTime.MinValue)
                ...
                return AbyssalPocket3StartTime - AbyssalSiteFinished;
            }
        }

        private TimeSpan AbyssalSiteTotalTime
        {
            get
            {
                if (AbyssalPocket1StartTime == DateTime.MinValue ||
                    AbyssalPocket2StartTime == DateTime.MinValue ||
                    AbyssalPocket3StartTime == DateTime.MinValue ||
                    AbyssalSiteFinished == DateTime.MinValue)
                    return TimeSpan.Zero;

                return AbyssalPocket1Time + AbyssalPocket2Time + AbyssalPocket3Time;
            }
        }
    }
}