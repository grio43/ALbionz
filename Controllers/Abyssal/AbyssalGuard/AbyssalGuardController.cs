...
namespace EVESharpCore.Controllers.Abyssal.AbyssalGuard
{
    public class AbyssalGuardController : BaseController
    {
        ...
        internal bool _orbitAbyssalBookmark => true;
        internal int _maxOrbitBookmarks => 10;

        internal bool IsAnyOtherNonFleetPlayerOnGrid => SimulateGankToggle || ESCache.Instance.EntitiesNotSelf.Any(e =>
            e.IsPlayer && e.Distance < 1000001 && Framework.FleetMembers.All(x => x.CharacterId != e._directEntity.OwnerId));


        List<EntityCache> OtherNonFleetPlayersOnGrid => ESCache.Instance.EntitiesNotSelf
            .Where(e => e.IsPlayer && e.Distance < 1000001 &&
                        Framework.FleetMembers.All(x => x.CharacterId != e._directEntity.OwnerId)) //.Select(e => e._directEntity)
            .ToList();
        ...
        internal AbyssalGuardState CurrentAbyssalGuardState
        {
            get => _state;
            set
            {
        ...
        private bool CheckBookmarksExist()
        {
            ...
            if (abyssBookmark == null)
            {
                ...
                CurrentAbyssalGuardState = AbyssalGuardState.Error;
                return false;
            }
        ...
        private (bool, DirectBookmark) AreWeCloseToOneBookmarkWhichIsOnLineBetweenAbyssSpotAndChosenMoon()
        {
            ...
            if (!bmsOnline.Any())
            {
                CurrentAbyssalGuardState = AbyssalGuardState.CreateAbyssalWarpinspot;
                return (false, null);
            }
        ...
        private void HandleCloak()
        {
            ...
            if (CurrentAbyssalGuardState == AbyssalGuardState.CloakAndWaitForTargets)
                return;
        ...
        private void EnsureHangarAccess()
        {
            ...
            if (ESCache.Instance.ActiveShip.TypeId == (int)TypeID.Orca)
            {
        ...
        public override void DoWork()
        {
            try
            {
                if (CurrentAbyssalGuardState != AbyssalGuardState.Error && ESCache.Instance.InSpace && (_selectedMoonId == null ||
                        !ESCache.Instance.Entities.Any(i => i.Id == _selectedMoonId.Value)))
                {
                    CurrentAbyssalGuardState = AbyssalGuardState.PickRandomMoon;
                }
                ...
                switch (CurrentAbyssalGuardState)
                {
                    case AbyssalGuardState.Start:
                        ...
                        if (EnsureInSpace())
                            CurrentAbyssalGuardState = AbyssalGuardState.GotoAbyssalWarpinspot;
                        break;
                    ...
                    case AbyssalGuardState.PickRandomMoon:
                        ...
                        if (_selectedMoonId == null || !ESCache.Instance.Entities.Any(i => i.Id == _selectedMoonId.Value))
                        {
                            ...
                            if (randomMoon == null)
                            {
                                ...
                                this.CurrentAbyssalGuardState = AbyssalGuardState.Error;
                                return;
                            }

                            _selectedMoonId = randomMoon.Id;
                            CurrentAbyssalGuardState = AbyssalGuardState.Start;
                        }
                    ...
                    case AbyssalGuardState.GotoAbyssalWarpinspot:
                        ...
                        if (_selectedWarpinBookmarkId != null)
                        {
                            ...
                            if (chosenBookmark != null)
                            {
                                ...
                                CurrentAbyssalGuardState = AbyssalGuardState.CloakAndWaitForTargets;
                                return;
                            }
                        }
                    ...
                    case
                        ...
                        // If we are at the spot (verify here again), cloak up and wait until any player entity appears on the grid which is not the abyssal runner
                        ...
                        if (IsAnyOtherNonFleetPlayerOnGrid)
                        {
                            ...
                            if (abyssRunnerFleetMember != null && abyssRunnerFleetMember.Entity != null)
                            {
                                ...
                                CurrentAbyssalGuardState = AbyssalGuardState.AlignToAbyssalRunner;
                                return;
                            }
                            else
                            {
                            ...
                            if (_orbitAbyssalBookmark)
                            {
                                ...
                                if (cloaks.Any(c => c.IsActive) && distanceToBm > 200_000)
                                {
                                    ...
                                    if (DirectEve.Interval(10 * minute, 15 * minute))
                                    {
                                        ...
                                        var bookmarkToMe = bm.Pos - Framework.ActiveShip.Entity.PositionInSpace;
                                        ...
                                        var bms = GetAllBookmarksWithinRange(0, 200_000, (Vec3)ESCache.Instance.ActiveShip.Entity.PositionInSpace);
                    ...
                    case AbyssalGuardState.AlignToAbyssalRunner:
                        {
                            if (Framework.Me.IsWarpingByMode)
                            {
                                ...
                                CurrentAbyssalGuardState = AbyssalGuardState.WarpToAbyssalRunner;
                                return;
                            }
                            ...
                            if (abyssRunnerFleetMember != null && abyssRunnerFleetMember.Entity != null)
                            {
                                ...
                                else
                                {
                                    if (abyssRunnerFleetMember.Entity.IsPod)
                                    {
                                        ...
                                        CurrentAbyssalGuardState = AbyssalGuardState.PVP;
                                        return;
                                    }
                                    else
                                    {
                    ...
                    case AbyssalGuardState.Error:
                        {
                            ...
                            if (ESCache.Instance.InSpace)
                            {
                                ...
                                {
                                    Traveler.TravelToBookmark(ESCache.Instance.DirectEve.Bookmarks
        ...
        private string _abyssRunnerCharName => "fixme";
            //ESCache.Instance.EveAccount.ClientSetting.AbyssalGuardMainSetting.AbyssCharacterName;
