    ...
    public class GridWatchController : BaseController
    {
        ...
        public override void DoWork()
        {
            try
            {
                ...
                var anyNonBluePlayerOnGrid = ESCache.Instance.EntitiesNotSelf.Any(e => e.IsPlayer && e.Distance < 1000000 && ESCache.Instance.DirectEve.Standings.GetCorporationRelationship(e._directEntity.CorpId) <= 0);
