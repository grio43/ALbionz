        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            action = new ActionQueueAction(new Action(() =>
            {
                try
                {
                    ...
                    var resList = ESCache.Instance.DirectEve.Modules.Select(d => new
                    {
                        d.TypeId,
                        d.HeatDamage,
                        d.OverloadState,
            ...
            action = new ActionQueueAction(new Action(() =>
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        var module = ESCache.Instance.DirectEve.Modules.FirstOrDefault(m => m.ItemId.Equals(itemId));
