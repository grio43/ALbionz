            ...
            action = new ActionQueueAction(new Action(() =>
            {
                try
                {
                    ...
                    var res = ent.Select(n => new
                    {
                        ...
                        //DistMeXYZPos = ESCache.Instance.DirectEve.ActiveShip.Entity.PositionInSpace.Distance(n.PositionInSpace),
