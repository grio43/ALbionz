...
namespace EVESharpCore.Questor.Actions
{
    public partial class ActionControl
    {
        ...
        private static void AddEcmNpcByNameAction(Action action, DirectAgentMission myMission, DirectAgent myAgent)
        {
            bool notTheClosest;
            ...
            if (!targetNames.Any())
            {
                Log.WriteLine("No targets defined in AddWarpScramblerByName action!");
