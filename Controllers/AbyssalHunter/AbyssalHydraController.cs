                ...
                if (string.IsNullOrEmpty(GankTargetCharacterName))
                {
                    ...
                    if (trace != null)
                    {
                        var target = Framework.Entities.FirstOrDefault(e =>
                            ...
                            && e.DirectAbsolutePosition.GetDistance(trace._directEntity.DirectAbsolutePosition) > 4000
                            && e.DirectAbsolutePosition.GetDistance(trace._directEntity.DirectAbsolutePosition) < 6000);
