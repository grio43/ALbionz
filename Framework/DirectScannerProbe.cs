...
namespace EVESharpCore.Framework
{
    ...
    public class DirectScannerProbe : DirectObject
    {
        ...
        public bool ClearCombatTargets()
        {
            //return DirectEve.ThreadedCall(DirectEve.GetLocalSvc("scanSvc").Attribute("ClearCombatTargets"), ProbeId, stepNumber);
            return false;
        }

        public bool ClearIgnoredResults()
        {
            //return DirectEve.ThreadedCall(DirectEve.GetLocalSvc("scanSvc").Attribute("ClearIgnoredResults"), ProbeId, stepNumber);
            return false;
        }

        public bool IgnoreResult()
        {
            //return DirectEve.ThreadedCall(DirectEve.GetLocalSvc("scanSvc").Attribute("IgnoreResult"), ProbeId, stepNumber);
            return false;
        }
