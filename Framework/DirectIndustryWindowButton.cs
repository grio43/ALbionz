...
namespace EVESharpCore.Framework
{
    ...
    public class DirectIndustryWindowButton : DirectObject
    {
        #region Fields
        ...
        internal DirectIndustryWindowButton(DirectEve directEve, PyObject pyBtn)
            : base(directEve)
        {
            _pyBtn = pyBtn;
        }
        ...
        public IndustryWindowButtonType Type { get; internal set; }
