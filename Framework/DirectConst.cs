...
namespace EVESharpCore.Framework
{
    ...
    internal class DirectConst : DirectObject
    {
        ...
        public PyObject AttributeDroneFocusFire => Const.Attribute("attributeDroneFocusFire");
        public PyObject AttributeDroneIsAggressive => Const.Attribute("attributeDroneIsAggressive");
        public PyObject AttributeDroneIsChaotic => Const.Attribute("attributeDroneIsChaotic");
        ...
        public PyObject AttributeEntityFactionLoss => Const.Attribute("attributeEntityFactionLoss");
        public PyObject AttributeEntityMass => Const.Attribute("attributeMass");
        ...
        public PyObject FlagCorpDeliveries => Const.Attribute("flagCorpDeliveries");
        public PyObject FlagCorpSAG1 => Const.Attribute("flagCorpSAG1");
        ...
        public PyObject FlagFighterBay => Const.Attribute("flagFighterBay");
        public PyObject FlagFightrerTube0 => Const.Attribute("flagFighterTube0");
        public PyObject FlagFightrerTube1 => Const.Attribute("flagFighterTube1");
        public PyObject FlagFightrerTube2 => Const.Attribute("flagFighterTube2");
        public PyObject FlagFightrerTube3 => Const.Attribute("flagFighterTube3");
        public PyObject FlagFightrerTube4 => Const.Attribute("flagFighterTube4");
        public PyObject FlagHangar => Const.Attribute("flagHangar");
        public PyObject FlagGeneralMiningHold => Const.Attribute("flagGeneralMiningHold");
        public PyObject FlagSpecializedSalvageHold => Const.Attribute("flagSpecializedSalvageHold");
        public PyObject FlagSpecializedAmmoHold => Const.Attribute("flagSpecializedAmmoHold");
        public PyObject FlagMobileDepotHold => Const.Attribute("flagMobileDepotHold");

        public PyObject FlagSpecializedPlanetaryCommoditiesHold => Const.Attribute("flagSpecializedPlanetaryCommoditiesHold");


        public PyObject FlagAmmoHold => Const.Attribute("flagSpecializedAmmoHold");
        ...
        public PyObject FlagFuelBay => Const.Attribute("flagSpecializedFuelBay");
        public PyObject FlagGasHold => Const.Attribute("flagSpecializedGasHold");
        public PyObject FlagIceHold => Const.Attribute("flagSpecializedIceHold");
        public PyObject FlagMineralHold => Const.Attribute("flagSpecializedMineralHold");
